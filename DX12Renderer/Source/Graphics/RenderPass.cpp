...
{
	commandList->ClearRenderTargetView(m_ColorAttachment->GetDescriptorHandle(), &m_Desc.ClearColor.x);
	commandList->ClearDepthStencilView(m_DepthAttachment->GetDescriptorHandle());
}
